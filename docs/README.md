...
- `ANALYTIC_SPINE_M2_DESIGN.md`
- `MATH_KERNEL_DESIGN.md`
- `EXTERNAL_EXPERIMENT_EXECUTION_PLAN.md`
- `EXTERNAL_EXPERIMENT_LANDSCAPE_HF_COLAB.md`
...
- `M3_EVIDENCE_EXECUTION_ADDENDUM_2026-09-09.md`
- `M3R_CLOSURE_RECOVERY_PLAN.md`
